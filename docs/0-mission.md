...
- [3-architecture.md](3-architecture.md) — data-source strategy, ontology, crate design, and implementation
- [4-testing.md](4-testing.md) — testing strategy, conformance fixtures, and quality gates
- [product/](product/) — market context, positioning, and ecosystem fit
- [journeys/](journeys/) — personas, user journeys, and BDD origins
- [engineering/](engineering/) — ADRs, deep-dive technical docs
